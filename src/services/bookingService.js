...
export const submitBookingReservation = async (bookingPayload) => {
  ...
  const formattedPayload = {
    ...
    customerName: bookingPayload.customer?.name || bookingPayload.customerName || '',
    customerPhone: bookingPayload.customer?.phone || bookingPayload.customerPhone || '',
    customerEmail: bookingPayload.customer?.email || bookingPayload.customerEmail || '',
