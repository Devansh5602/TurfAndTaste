...
- Exact next safe task: consume `/api/v2/quotes` in the Booking UI after selection changes, show its authoritative amount/deposit, and require a current quote before legacy booking submission. Do not begin payment-contract replacement until this is verified.
