...
- Facilities now obtain sports rates from the same live pricing store as Booking and Pricing. Public sports/café hours were aligned with the booking schedule (sports: 6 AM–6 AM; café: 7 AM–11 PM), and the default profile no longer falsely labels a new visitor as VIP.
